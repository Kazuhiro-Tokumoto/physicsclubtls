class syunoa {
  private p =
    0x9714274a520c2a7015d654d9703e4428fec7ba0c648e0f6dd3ca6347837764adn;
  private q = 0xf359c9c1f8c281129933a74b1f542bbc3364bb13n;
  private g =
    0x50353a782f629d94b260b900177baf0d80df53c8750bed7ee7c3e4c16e2042d1n;
  ...
  public sign(message: Uint8Array, x: bigint): { r: bigint; s: bigint } {
    const k =
      this.sha256(
        new Uint8Array([...message, ...this.BigintToBytes(x)]),
      ).reduce((acc, b) => (acc << 8n) | BigInt(b), 0n) % this.q;
...
const key =
  syunoaInstance.genkey(8167519870365982464598178956789716598267350983276n);
