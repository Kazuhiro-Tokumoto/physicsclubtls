...
import { DYLA, DYLADomain, DYLAEntry, DYLACertificate } from "./DYLA.js";
...
export function generateRootCA(): { privateKey: string; publicKey: string } {
...
export function issueIntermediateCA(
  parentCAName: string,
...
export function issueEndEntity(
  parentCAName: string,
  parentPrivateKey: string,
  chainEntries: DYLAEntry[],
  cn: string,
  country: string,
  state: string,
  city: string,
...
export function issueSubCA(
  parentEntry: DYLAEntry,
  parentPrivateKey: string,
  chainEntries: DYLAEntry[],
  cn: string,
  country: string,
